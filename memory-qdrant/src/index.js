...
const { searchMemories, storeMemory, isHealthy, getStats, configure } = require("./qdrant-client.js");
...
const plugin = {
  ...
  configSchema: {
    ...
    properties: {
      ...
      serverName: { type: "string", default: "qdrant-memory", description: "mcporter server name for Qdrant" },
