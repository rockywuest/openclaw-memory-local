...
describe("nox-fingerprint", () => {
  ...
  describe("saveFingerprint / loadFingerprint", () => {
    it("persists and loads fingerprint", () => {
      const fp = {
        ...
        distribution: { work: 0.5, family: 0.5, tech: 0, finance: 0, health: 0, social: 0, creative: 0, system: 0 },
        gini: 0.3,
  ...
  describe("updateFingerprint", () => {
    it("updates fingerprint after cooldown", () => {
      ...
      const old = {
        ...
        distribution: { work: 0.8, family: 0.2, tech: 0, finance: 0, health: 0, social: 0, creative: 0, system: 0 },
        gini: 0.5,
        top_domains: [],
        topology_hash: "old",
      };
  ...
  describe("generateContextInjection", () => {
    it("generates markdown summary", () => {
      const fp = {
        timestamp: new Date().toISOString(),
        distribution: { work: 0.5, tech: 0.3, family: 0.2, finance: 0, health: 0, social: 0, creative: 0, system: 0 },
        gini: 0.4,
        top_domains: [
          { domain: "work", pct: 0.5 },
          { domain: "tech", pct: 0.3 },
